...
+"</html>");
		...
		JLabel lblThe = new JLabel("<html>In order to learn more about the platform or download and use it you may visit the platform's application repositories as shown below:<ul>"
